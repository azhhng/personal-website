    ...
    return (
        <div className="project-container">
            ...
            <div className="right-container">
                <h3>This project was made for PHL342: Mind and Machines. The instructor of the course allowed students to create an open-ended project that the public could view; I decided to create a web application.</h3>
            </div>
            <div className="left-container">
                <h3>Users will input their own name and create a robot of their own. In addition, they will have to make decisions that will alter the course of the game. There are three endings for the user to get.</h3>
            </div>
            <div className="technologies-container">
                <h3>Frontend: <span className="technology">React.js, Javascript, HTML & CSS</span></h3>
                <h3>Backend: <span className="technology">Express.js, Node.js, Typescript</span></h3>
            </div>
            ...
            <div className="dialogue-box">
                <h3>&gt; Hey, I'm Slash!</h3>
                <h3>&gt; If you want to know more about me, look at our <a href="https://social-robots.herokuapp.com/">website</a>.</h3>
